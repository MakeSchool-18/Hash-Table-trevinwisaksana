...
class LinkedList(object):
    ...
    def as_list(self):
        ...
        'Best case and worst case runtime: Ω(n) and O(n)'
    ...
    def is_empty(self):
        ...
        return self.head is None 'O(1), constant running time'
    ...
    def delete(self, item):
        ...
        while current is not None: # While the list is not empty
            'Best case and worst case runtime(respectively): Ω(1) and O(n)'
        ...
        return "Item not found" 'Constant running time to return String' # Return item not found

        self.size -= 1 'Constant running time to decrement'

    def find(self, quality):
        """Return an item from this linked list satisfying the given quality
           Best case running time:
            – Ω(1) if item is near the head
